...
function obras_render_dashboard() {
    ...
    <div class="wrap">
        ...
        <div style="display:flex; gap:20px; flex-wrap:wrap; margin-top:30px;">
            <a href="post-new.php?post_type=bitacora" class="button button-primary button-hero">✍️<br>Nueva Nota</a>
            <a href="edit.php?post_type=bitacora" class="button button-secondary button-hero">📋<br>Ver Notas</a>
